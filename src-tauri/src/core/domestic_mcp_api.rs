...
impl DomesticMcpMarket {
    ...
    fn mcpso_servers() -> Vec<DomesticMcpServer> {
        vec![
            DomesticMcpServer {
                id: "mcpso-filesystem".into(),
                name: "Filesystem".into(),
                description: "本地文件系统读写、目录扫描的官方 MCP".into(),
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/filesystem".into(),
                category: "Filesystem".into(),
                installs: 185000,
            },
            DomesticMcpServer {
                id: "mcpso-github".into(),
                name: "GitHub".into(),
                description: "管理 Issue / PR / 仓库内容的 GitHub MCP".into(),
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/github".into(),
                category: "Development".into(),
                installs: 162000,
            },
            DomesticMcpServer {
                id: "mcpso-puppeteer".into(),
                name: "Puppeteer".into(),
                description: "无头浏览器自动化、截图、抓取".into(),
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/puppeteer".into(),
                category: "Browser".into(),
                installs: 134000,
            },
            DomesticMcpServer {
                id: "mcpso-postgres".into(),
                name: "PostgreSQL".into(),
                description: "查询 / 写入 PostgreSQL 数据库的 MCP".into(),
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/postgres".into(),
                category: "Database".into(),
                installs: 98000,
            },
            DomesticMcpServer {
                id: "mcpso-bravesearch".into(),
                name: "Brave Search".into(),
                description: "Brave Web Search API 集成".into(),
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/brave-search".into(),
            ...
            DomesticMcpServer {
                ...
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/fetch".into(),
                category: "Web".into(),
                installs: 76000,
            },
            DomesticMcpServer {
                id: "mcpso-memory".into(),
                name: "Memory".into(),
                description: "对话记忆持久化（知识图谱 KG）".into(),
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/memory".into(),
            ...
            DomesticMcpServer {
                ...
                provider: McpProvider::McpSo,
                url: "https://mcp.so/server/time".into(),
    ...
    fn modelscope_servers() -> Vec<DomesticMcpServer> {
        vec![
            DomesticMcpServer {
                id: "modelscope-search".into(),
                name: "ModelScope 搜索".into(),
            ...
            DomesticMcpServer {
                id: "modelscope-paraformer".into(),
                name: "Paraformer 语音识别".into(),
                description: "中文语音识别（达摩院开源）".into(),
                provider: McpProvider::ModelScope,
                url: "https://modelscope.cn/mcp/servers/paraformer".into(),
                category: "AI/Audio".into(),
                installs: 42000,
            },
            DomesticMcpServer {
                id: "modelscope-cosyvoice".into(),
                name: "CosyVoice 语音合成".into(),
    ...
    fn higress_servers() -> Vec<DomesticMcpServer> {
        vec![
            ...
            DomesticMcpServer {
                id: "higress-arxiv".into(),
                name: "arXiv 论文搜索".into(),
